...
export default function LoginPrompt({ darkMode }) {
  ...
  return (
    <>
      ...
      {/* Card */}
      <div
        className={`max-w-2xl rounded-2xl       w-full p-12 lg:p-14  text-center border transition-all duration-300 transform shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] ${darkMode
      ...
      >
        ...
        <div className="mb-8 relative flex justify-center">
          ...
          >
            <Lock
              className={`w-10 h-10 ${darkMode ? "text-blue-400" : "text-blue-600"
                }`}
            />
          </div>
        </div>
        ...
        {/* Heading */}
        <h2
          className={`text-3xl font-black tracking-tight mb-4 ${darkMode ? "text-white" : "text-slate-900"
            }`}
        >
        ...
        {/* Description */}
        <p
          className={`text-base leading-relaxed mb-10 opacity-70 ${darkMode ? "text-slate-400" : "text-slate-600"
            }`}
        >
