...
export default function CookiesPolicyPage() {
  ...
  const containerClass = darkMode
    ? "min-h-screen py-24 px-4 sm:px-8 flex items-center justify-center bg-[#020617] text-white relative font-sans"
    : "min-h-screen py-24 px-4 sm:px-8 flex items-center justify-center bg-slate-50 text-slate-900 relative font-sans";

  return (
    <div className={containerClass}>
      <div className={`absolute inset-0 ${darkMode ? 'bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-900/20 via-[#020617] to-[#020617]' : 'bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-50/80 via-slate-50 to-slate-50'} pointer-events-none`} />

      <div className="relative z-10 max-w-3xl w-full">
        
        <div className={`overflow-hidden rounded-[2.5rem] border shadow-2xl ${darkMode ? "bg-[#020617]/80 backdrop-blur-xl border-slate-800 shadow-purple-500/5" : "bg-white border-slate-200 shadow-slate-200"}`}>
          
          <div className={`p-12 md:p-16 border-b ${darkMode ? "border-slate-800 bg-slate-900/30" : "border-slate-100 bg-slate-50/50"}`}>
            <div className="w-16 h-16 rounded-2xl bg-purple-500/10 flex items-center justify-center text-purple-500 mb-8 border border-purple-500/20">
              <Cookie size={32} />
            </div>
          ...
          <div className="p-12 md:p-16 space-y-12">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold flex items-center gap-2"><Zap className="text-purple-500 w-5 h-5"/> Required Auth Tokens</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold flex items-center gap-2"><ShieldAlert className="text-purple-500 w-5 h-5"/> Diagnostic Telemetry</h3>
              <p className={`leading-relaxed ${darkMode ? "text-slate-300" : "text-slate-600"}`}>
            ...
            <div className={`p-6 rounded-2xl text-sm font-medium border ${darkMode ? "bg-purple-500/5 border-purple-500/20 text-purple-400" : "bg-purple-50 border-purple-200 text-purple-700"}`}>
