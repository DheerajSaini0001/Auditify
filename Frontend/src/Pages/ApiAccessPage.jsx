      ...
      <div className="relative z-10 max-w-5xl w-full mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-16 border-b pb-12 border-slate-500/20">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-violet-500/10 text-violet-500 text-sm font-black tracking-widest uppercase border border-violet-500/20">
          ...
          <div className={`p-6 rounded-2xl border backdrop-blur-md ${darkMode ? "bg-violet-500/5 border-violet-500/20" : "bg-white border-slate-200 shadow-xl"}`}>
            <h4 className="font-bold text-sm mb-2 opacity-70 uppercase tracking-widest">Base URL</h4>
            <div className="text-lg font-mono font-bold text-violet-500">https://api.auditify.com/v1</div>
            <div className="mt-4 flex gap-4 text-xs font-semibold">
              <span className="flex items-center gap-1 text-violet-500"><CheckCircle2 size={14}/> 99.9% Uptime</span>
        ...
        {/* Auth Section */}
        <div className={`relative overflow-hidden rounded-3xl border transition-all duration-300 ${darkMode ? "bg-[#020617] border-slate-800" : "bg-white border-slate-200 shadow-2xl shadow-slate-200/50"}`}>
          <div className="absolute top-0 w-full h-1 bg-gradient-to-r from-violet-500 via-indigo-500 to-purple-500"></div>
          <div className="p-8 md:p-12 md:flex gap-12 items-center">
            ...
            <div className={`flex-1 rounded-2xl border overflow-hidden mt-8 md:mt-0 ${darkMode ? "bg-[#020617] border-slate-800" : "bg-slate-900 border-slate-800"}`}>
              ...
              <div className="p-6 font-mono text-sm leading-8 text-slate-300 overflow-x-auto">
                <span className="text-pink-400">"Authorization"</span>: <span className="text-violet-400">"Bearer sk_live_xxxxxxxxxxx"</span>,<br/>
                <span className="text-pink-400">"Content-Type"</span>: <span className="text-violet-400">"application/json"</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`relative overflow-hidden rounded-3xl border transition-all duration-300 ${darkMode ? "bg-[#020617] border-slate-800" : "bg-white border-slate-200 shadow-2xl shadow-slate-200/50"}`}>
          <div className="absolute top-0 w-full h-1 bg-gradient-to-r from-violet-500 via-purple-500 to-indigo-500"></div>
          <div className="p-8 md:p-12 md:flex flex-row-reverse gap-12 items-center">
            ...
            <div className={`flex-1 rounded-2xl border overflow-hidden mt-8 md:mt-0 ${darkMode ? "bg-[#020617] border-slate-800" : "bg-slate-900 border-slate-800"}`}>
              <div className="flex px-4 py-3 border-b border-white/10 items-center justify-between">
                <div className="text-xs font-bold text-violet-400 bg-violet-400/10 px-2 py-1 rounded">POST /v1/scan</div>
              </div>
              <div className="p-6 font-mono text-sm leading-8 text-slate-300 overflow-x-auto">
                <span className="text-violet-400">curl</span> -X POST https://api.auditify.com/v1/scan \<br/>
                &nbsp;&nbsp;-H <span className="text-violet-400">"Authorization: Bearer sk_live_..."</span> \<br/>
