    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-6 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        <motion.div 
          ...
          className={`absolute -top-24 -left-24 w-[500px] h-[500px] rounded-full blur-[120px] transition-colors duration-1000 ${
        ...
        <motion.div 
          ...
          className={`absolute -bottom-24 -right-24 w-[500px] h-[500px] rounded-full blur-[120px] transition-colors duration-1000 ${
            darkMode ? 'bg-indigo-500/5' : 'bg-indigo-400/20'
          }`}
        />
        <div className={`absolute inset-0 bg-[center_top_-1px] [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] transition-colors duration-1000 ${
          darkMode ? 'bg-grid-white' : 'bg-grid-black/[0.03]'
        }`} />
      </div>
      ...
      >
        ...
        <div className={`relative p-8 md:p-10 rounded-[2.5rem] backdrop-blur-3xl overflow-hidden transition-all duration-300 border shadow-2xl ${
  darkMode 
    ...
    : 'bg-white/90 text-slate-900 border-white shadow-[0_20px_60px_rgba(0,0,0,0.05)]'
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className={`text-3xl font-black tracking-tight mb-3 leading-tight transition-colors duration-300 ${
            ...
            <p className={`text-xs font-bold uppercase tracking-widest opacity-80 transition-colors duration-300 ${
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className={`absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none transition-colors duration-300 ${
                  darkMode ? 'group-focus-within:text-blue-400' : 'group-focus-within:text-blue-600'
                }`}>
                  <Link2 className={`h-5 w-5 transition-colors duration-300 ${
                ...
                <input
                  ...
                  required
                  autoFocus
                  className={`block w-full pl-14 pr-5 py-4 rounded-2xl border-2 transition-all text-base font-bold shadow-sm outline-none ${
                    darkMode 
            ...
            <motion.div 
              ...
              className={`border rounded-2xl p-4 flex gap-4 items-start shadow-sm transition-all duration-300 ${
                darkMode
            ...
            >
              <div className="flex-shrink-0">
                <div className={`h-8 w-8 rounded-xl shadow-sm flex items-center justify-center transition-colors duration-300 ${
              ...
              <div>
                <h4 className={`text-[10px] font-black mb-0.5 tracking-[0.1em] uppercase transition-colors duration-300 ${
                  darkMode ? 'text-blue-200' : 'text-blue-900'
                }`}>Security Note</h4>
                <p className={`text-[10px] font-bold leading-relaxed transition-colors duration-300 ${
                  darkMode ? 'text-blue-400/70' : 'text-blue-700/80'
                }`}>
            ...
            <div className="flex flex-col gap-4 pt-2">
              ...
              <button
                ...
                className={`group flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] py-2 transition-all ${
