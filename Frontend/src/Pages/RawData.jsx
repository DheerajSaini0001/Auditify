              ...
              <div className={`p-8 rounded-2xl flex flex-col transition-all duration-300 hover:-translate-y-1 ${innerCardClass}`}>
                ...
                <div className="mt-auto pt-8">
                  <button
                    ...
                    className="group w-full flex items-center justify-center gap-3 py-4 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-500 shadow-lg shadow-blue-600/20 transition-all hover:shadow-blue-600/30 active:scale-[0.98]"
                  >
