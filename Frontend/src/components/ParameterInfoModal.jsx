        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <div className={`relative w-full max-w-4xl rounded-[32px] shadow-2xl overflow-hidden max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-200 ${darkMode ? "bg-gray-900 border border-gray-800" : "bg-card"}`}>
                ...
                <div className="p-8 pb-2 flex items-start gap-5 flex-shrink-0">
                    {/* Header Icon Circle */}
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0 ${darkMode ? "bg-blue-900/20 border border-blue-800/50" : "bg-accentsoft border border-line"}`}>
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-4 custom-scrollbar">
                    ...
                    {(info.whatThisParameterIs || info.whatThisMetricIs) && (
                        <div className={`p-5 rounded-2xl border transition-colors ${darkMode ? "bg-gray-800/40 border-gray-700 hover:border-gray-600" : "bg-cardsoft border-line hover:border-blue-100 hover:shadow-sm"}`}>
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 mt-0.5">
                                    <Gauge className="w-6 h-6 text-blue-500" />
                                </div>
                                <div className="flex-1">
                                    <h3 className={`font-semibold text-base mb-1.5 ${darkMode ? "text-gray-100" : "text-ink"}`}>Description</h3>
                    ...
                    {info.whatItCalculates && (
                        <div className={`p-5 rounded-2xl border transition-colors ${darkMode ? "bg-gray-800/40 border-gray-700 hover:border-gray-600" : "bg-cardsoft border-line hover:border-indigo-100 hover:shadow-sm"}`}>
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 mt-0.5">
                                    <Calculator className="w-6 h-6 text-indigo-500" />
                                </div>
                                <div className="flex-1">
                                    <h3 className={`font-semibold text-base mb-1.5 ${darkMode ? "text-gray-100" : "text-ink"}`}>What it calculates</h3>
                                    <div className={`text-sm leading-relaxed ${darkMode ? "text-gray-400" : "text-muted"}`}>
                                        {info.whatItCalculates}
                                    </div>
                                </div>
                    ...
                    {info.whyItMatters && (
                        <div className={`p-5 rounded-2xl border transition-colors ${darkMode ? "bg-gray-800/40 border-gray-700 hover:border-gray-600" : "bg-cardsoft border-line hover:border-amber-100 hover:shadow-sm"}`}>
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 mt-0.5">
                    ...
                    {info.thresholds && (
                        <div className={`p-5 rounded-2xl border transition-colors ${darkMode ? "bg-gray-800/40 border-gray-700 hover:border-gray-600" : "bg-cardsoft border-line hover:border-violet-100 hover:shadow-sm"}`}>
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 mt-0.5">
                                    <Activity className="w-6 h-6 text-violet-500" />
                                </div>
                                <div className="flex-1">
                                    <h3 className={`font-semibold text-base mb-1.5 ${darkMode ? "text-gray-100" : "text-ink"}`}>Threshold</h3>
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-2 mt-2">
                                            {info.thresholds.good && (
                                                <div className={`flex-1 p-2 rounded border ${darkMode ? "bg-emerald-900/20 border-emerald-800 text-emerald-300" : "bg-emerald-50 border-emerald-100 text-emerald-700"}`}>
                                                    <div className="text-[10px] font-semibold uppercase tracking-wider opacity-70 mb-0.5">Good</div>
                                            ...
                                            {info.thresholds.poor && (
                                                <div className={`flex-1 p-2 rounded border ${darkMode ? "bg-rose-900/20 border-rose-800 text-rose-300" : "bg-rose-50 border-rose-100 text-rose-700"}`}>
                                                    <div className="text-[10px] font-semibold uppercase tracking-wider opacity-70 mb-0.5">Poor</div>
                    ...
                    {info.actualReasonsForFailure && (
                        <div className={`p-5 rounded-2xl border transition-colors ${darkMode ? "bg-gray-800/40 border-gray-700 hover:border-gray-600" : "bg-cardsoft border-line hover:border-rose-100 hover:shadow-sm"}`}>
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 mt-0.5">
                                    <AlertTriangle className="w-6 h-6 text-rose-500" />
                                </div>
                                <div className="flex-1">
                                    <h3 className={`font-semibold text-base mb-1.5 ${darkMode ? "text-gray-100" : "text-ink"}`}>Common Reasons for Failure</h3>
                                    {Array.isArray(info.actualReasonsForFailure) ? (
                                        <ul className={`list-disc list-outside ml-4 space-y-1 ${darkMode ? "text-gray-400" : "text-muted"}`}>
                    ...
                    {info.howToOvercomeFailure && (
                        <div className={`p-5 rounded-2xl border transition-colors ${darkMode ? "bg-gray-800/40 border-gray-700 hover:border-gray-600" : "bg-cardsoft border-line hover:border-emerald-100 hover:shadow-sm"}`}>
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 mt-0.5">
                                    <Wrench className="w-6 h-6 text-emerald-500" />
                                </div>
                                <div className="flex-1">
                                    <h3 className={`font-semibold text-base mb-1.5 ${darkMode ? "text-gray-100" : "text-ink"}`}>How to Improve</h3>
                    ...
                    {info.guideLink && (
                        <div className={`pt-6 mt-4 border-t ${darkMode ? "border-gray-800" : "border-line"}`}>
                            ...
                            >
                                <span className={`font-semibold text-base ${darkMode ? "text-blue-400 group-hover:text-blue-300" : "text-accent group-hover:text-accent"}`}>
                                    Read full guide
                                </span>
