        ...
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className={`
                    ...
                    ${darkMode
                        ? "bg-white/5 border-white/8 hover:bg-white/10 hover:border-violet-500/20"
                        : "bg-slate-50 border-slate-200 hover:bg-white hover:border-violet-400/40"}
                    ${disabled ? "opacity-40 cursor-not-allowed" : "active:scale-[0.97]"}
                `}
            >
                <span className={`flex-shrink-0 transition-colors ${darkMode ? 'text-slate-400 group-hover/drop:text-violet-400' : 'text-slate-400 group-hover/drop:text-violet-600'}`}>
                ...
                <ChevronDown className={`w-3 h-3 transition-transform duration-300 ${isOpen ? "rotate-180 text-violet-500" : darkMode ? "text-slate-600" : "text-slate-400"}`} />
            </button>
    ...
    return (
        <motion.div
            ...
            className={`relative flex flex-col items-center justify-center p-6 rounded-3xl border overflow-hidden
                ${darkMode ? 'bg-[#020617]/80 border-white/5' : 'bg-white border-slate-100 shadow-lg shadow-slate-100'}`}
        >
            {/* Ambient glow */}
        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                ...
                <div className="absolute top-[-15%] left-[-10%] w-[500px] h-[500px] rounded-full opacity-30"
                    style={{ background: 'radial-gradient(circle, #8b5cf640 0%, transparent 70%)', filter: 'blur(80px)', animation: 'pulse 8s ease-in-out infinite' }} />
                <div className="absolute top-[30%] right-[-8%] w-[380px] h-[380px] rounded-full opacity-20"
                    style={{ background: 'radial-gradient(circle, #8b5cf640 0%, transparent 70%)', filter: 'blur(80px)', animation: 'pulse 10s ease-in-out 3s infinite' }} />
                ...
                >
                    ...
                    >
                        <motion.div
                            animate={focused
                                ? { boxShadow: darkMode
                                    ? '0 0 0 2px rgba(139,92,246,0.35), 0 20px 60px -10px rgba(0,0,0,0.6)'
                                    : '0 0 0 2px rgba(139,92,246,0.3), 0 20px 60px -10px rgba(0,0,0,0.12)' }
                                : { boxShadow: darkMode
                        ...
                        <div className="flex items-center gap-2.5">
                            <div className="flex -space-x-2">
                                {[
                                    ...
                                    <div key={i} className={`w-8 h-8 rounded-full bg-gradient-to-br ${g} border-2 ${darkMode ? 'border-[#020617]' : 'border-[#F8FAFC]'}`} />
                                ))}
                            </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 mb-1">
                            {['bg-rose-400/50', 'bg-amber-400/50', 'bg-violet-400/50'].map((c, i) => (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <ScoreRing score={94} color="#8b5cf6" label="SEO Score"     delay={0.5} darkMode={darkMode} />
                            <ScoreRing score={88} color="#c4b5fd" label="Performance"   delay={0.7} darkMode={darkMode} />
                        </div>
                        ...
                        <div className={`rounded-2xl border p-5 space-y-4 ${darkMode ? 'bg-white/3 border-white/6' : 'bg-slate-50 border-slate-100'}`}>
                            {[
                                ...
                                { label: "Security",      pct: 91, color: "#a78bfa" },
                        ...
                        {/* Footer badge */}
                        <div className={`flex items-center gap-2.5 px-4 py-3 rounded-2xl ${darkMode ? 'bg-violet-500/8 border border-violet-500/15' : 'bg-violet-50 border border-violet-100'}`}>
                            <Zap size={15} className="text-violet-500 flex-shrink-0" />
                            <span className={`text-[11px] font-semibold ${darkMode ? 'text-violet-400' : 'text-violet-700'}`}>
                    ...
                    <div className="fixed inset-0 z-[200] flex items-center justify-center px-4">
                        ...
                        >
                            ...
                            <div className="absolute top-0 right-0 w-40 h-40 opacity-10 pointer-events-none"
                                style={{ background: 'radial-gradient(circle, #8b5cf6, transparent 70%)', filter: 'blur(40px)', transform: 'translate(30%, -30%)' }} />

                            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center shadow-xl shadow-violet-500/20 rotate-6">
                            ...
                            <div className={`w-full rounded-2xl border p-5 space-y-4 ${darkMode ? 'bg-white/4 border-white/8' : 'bg-slate-50 border-slate-200'}`}>
                                ...
                                <button
                                    ...
                                    className="w-full py-3 bg-violet-500 hover:bg-violet-400 text-white font-semibold rounded-xl
                                        transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed shadow-lg shadow-violet-500/20 active:scale-[0.98]"
                                >
