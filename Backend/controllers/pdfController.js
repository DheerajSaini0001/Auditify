...
export const generatePDFReport = async (req, res) => {
  try {
    ...
    <body>
        <div class="header">
            <div class="logo">DealerPulse.</div>
            <div class="url-info">
                <h1>${report.url}</h1>
        ...
        <div class="methodology-section" style="padding: 40px; border: 2px solid var(--border); border-radius: 16px; background: white; margin-bottom: 40px; min-height: 800px;">
             ...
             <p style="font-size: 16px; line-height: 2.5; color: #475569;">
                 ...
                 5. Re-run the DealerPulse tool after deployments to verify changes in Lab/Crux data.<br/>
             </p>
             <div style="margin-top: 150px; text-align: center;">
                 <div class="logo" style="font-size: 32px; opacity: 0.3;">DealerPulse.</div>
                 <p style="color: #94a3b8; margin-top: 10px;">End of Report</p>
             </div>
        </div>

        <div class="footer">
            Generated by DealerPulse AI Engine. © 2026 DealerPulse. All Rights Reserved.
            <br/>
    ...
    res.setHeader(
      "Content-Disposition",
      `attachment; filename=DealerPulse-Report-${report.url.replace(/[^a-z0-9]/gi, "-")}.pdf`
    );
