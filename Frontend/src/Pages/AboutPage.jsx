    ...
    <div className={containerClass}>
      ...
      <div className="mt-28 animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-200 max-w-7xl w-full">
        <div className="text-center mb-16 px-4">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 via-cyan-500 to-blue-500">
            How We Score Your Site
          </h2>
          <p className={`max-w-2xl mx-auto text-lg ${darkMode ? "text-slate-400" : "text-slate-600"}`}>
            We analyze <span className="text-emerald-500 font-bold">100+ data points</span> across 7 key categories to give you precise, actionable insights. Here's exactly how our algorithm works.
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <div className={`group p-8 rounded-3xl border transition-all duration-300 hover:shadow-2xl ${darkMode ? 'bg-slate-900/50 border-slate-800 hover:border-blue-500/30 hover:bg-slate-900/80 backdrop-blur-xl' : 'bg-white border-slate-100 shadow-xl shadow-slate-200/50 hover:border-blue-200'}`}>
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
              <div className="p-4 rounded-2xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 text-blue-500 shadow-inner">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
              {[
                { label: "LCP", sub: "Load Speed", weight: "25%", color: "text-blue-500" },
                { label: "TBT", sub: "Responsiveness", weight: "25%", color: "text-blue-500" },
                { label: "INP", sub: "Interactivity", weight: "15%", color: "text-cyan-500" },
                { label: "FCP", sub: "First Paint", weight: "10%", color: "text-teal-500" },
                { label: "Speed Index", sub: "Visual Load", weight: "10%", color: "text-teal-500" },
          ...
          <div className={`group p-8 rounded-3xl border transition-all duration-300 hover:shadow-2xl ${darkMode ? 'bg-slate-900/50 border-slate-800 hover:border-purple-500/30 hover:bg-slate-900/80 backdrop-blur-xl' : 'bg-white border-slate-100 shadow-xl shadow-slate-200/50 hover:border-purple-200'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                {
                  title: "Technical Foundation", color: "from-indigo-500 to-blue-500", items: [
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Accessibility */}
            <div className={`p-8 rounded-3xl border transition-all duration-300 hover:shadow-2xl ${darkMode ? 'bg-slate-900/50 border-slate-800 hover:border-emerald-500/30' : 'bg-white border-slate-100 shadow-xl shadow-slate-200/50 hover:border-emerald-200'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className={`p-6 rounded-3xl border ${darkMode ? 'bg-slate-900/40 border-slate-800' : 'bg-white border-slate-200 shadow-lg'}`}>
              ...
              <div className="space-y-3">
                {[
                  { l: "Tap Targets", r: "3 pts", c: "text-emerald-500" },
                  { l: "Text Size", r: "3 pts", c: "text-emerald-500" },
                  { l: "Mobile Viewport", r: "3 pts", c: "text-emerald-500" },
