    ...
    <div className={containerClass}>
      <div className="relative z-10 max-w-4xl w-full mx-auto space-y-8">
        ...
        <PageHeader
          ...
          title="Terms of"
          titleAccent="Service."
          subtitle="The legal constraints, limitations of liability, and usage bounds for the Site Audit platform."
          darkMode={darkMode}
        />
        ...
        <div className={`p-10 rounded-3xl border transition-all ${darkMode ? "bg-slate-900/40 border-slate-800 shadow-2xl shadow-black" : "bg-card border-line shadow-2xl shadow-slate-200/50"}`}>
          <div className={`space-y-8 text-base md:text-lg leading-relaxed ${darkMode ? "text-slate-300" : "text-inksoft"}`}>
            ...
            <section className="space-y-4">
              ...
              <p>Site Audit implements a highly resource-intensive scraping phase. Programmatically forcing the engine to audit the same domain structure aggressively every few seconds is functionally equivalent to launching a Denial of Service (Layer 7) sequence.</p>
            ...
            <section className="space-y-4">
              ...
              <p>Site Audit accepts zero legal or financial liability if actions taken based on our audit diagnostics induce accidental downtime, layout fractures, or ranking drops on major search consolidators. The score holds no legal guarantee of SEO infallibility.</p>
            </section>
