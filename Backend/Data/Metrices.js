...
export default function Metrices(MetricesCalculation_Data) {
  
  let metrices = null;

  switch(MetricesCalculation_Data.report) {

    case 'technicalMetrics':
        metrices = {
    Schema:MetricesCalculation_Data.metric.structuredData,
    ...
    Technical_Performance: {
      Core_Web_Vitals: {
        LCP:{
          Score: MetricesCalculation_Data.metric.coreWebVitals.lcpScore,
          Value: MetricesCalculation_Data.metric.coreWebVitals.lcpValue,
          Parameter:'Set 1 if LCP ≤ 2500ms, otherwise set 0'
        },
        FID:{
          Score: MetricesCalculation_Data.metric.coreWebVitals.fidScore,
          Value: MetricesCalculation_Data.metric.coreWebVitals.fidValue,
          Parameter:'Set 1 if FID ≤ 100ms, otherwise set 0'
        },
        CLS:{
          Score: MetricesCalculation_Data.metric.coreWebVitals.clsScore,
          Value: MetricesCalculation_Data.metric.coreWebVitals.clsValue,
          Parameter:'Set 1 if CLS ≤ 0.1, otherwise set 0'
        },
        FCP:{
          Score: MetricesCalculation_Data.metric.coreWebVitals.fcpScore,
          Value: MetricesCalculation_Data.metric.coreWebVitals.fcpValue,
          Parameter:'Set 1 if FCP ≤ 1800ms, otherwise set 0'
        },
        TTFB:{
          Score: MetricesCalculation_Data.metric.coreWebVitals.ttfbScore,
          Value: MetricesCalculation_Data.metric.coreWebVitals.ttfbValue,
          Parameter:'Set 1 if TTFB ≤ 200ms, otherwise set 0'
        },
        TBT:{
          Score: MetricesCalculation_Data.metric.coreWebVitals.tbtScore,
          Value: MetricesCalculation_Data.metric.coreWebVitals.tbtValue,
          Parameter:'Set 1 if TBT ≤ 300ms, otherwise set 0'
        },
        SI:{
          Score: MetricesCalculation_Data.metric.coreWebVitals.siScore,
          Value: MetricesCalculation_Data.metric.coreWebVitals.siValue,
          Parameter:'Set 1 if SI ≤ 3000ms, otherwise set 0'
        },
        INP:{
          Score: MetricesCalculation_Data.metric.coreWebVitals.inpScore,
          Value: MetricesCalculation_Data.metric.coreWebVitals.inpValue,
          Parameter:'Set 1 if INP ≤ 200ms, otherwise set 0'
        },
        Core_Web_Vitals_Total_Score: MetricesCalculation_Data.metric.coreWebVitals.coreWebVitalsTotal,
      },
      Delivery_and_Render: {
        Compression:{
          Score: MetricesCalculation_Data.metric.deliveryAndRender.compressionScore,
          Parameter:'Set 1 if "gzip" or "brotli" compression is enabled, otherwise set 0 if it’s disabled or missing.'
        },
        Caching:{
          Score: MetricesCalculation_Data.metric.deliveryAndRender.cachingScore,
          Value: MetricesCalculation_Data.metric.deliveryAndRender.cachingValue,
          Parameter:'Set 1 if static resources have TTL ≥ 7 days, otherwise set 0 if TTL is less than 7 days or missing'
        },
        Resource_Optimization:{
          Score: MetricesCalculation_Data.metric.deliveryAndRender.resourceOptimizationScore,
          Parameter:'Set 1 if images are optimized, CSS/JS minified, and offscreen images deferred; otherwise set 0.'
        },
        Render_Blocking:{
          Score: MetricesCalculation_Data.metric.deliveryAndRender.renderBlockingScore,
          Parameter:'Set 1 if there are no render-blocking CSS/JS resources, otherwise set 0'
        },
        HTTP:{
          Score: MetricesCalculation_Data.metric.deliveryAndRender.httpsScore,
          Parameter:'Set 1 if HTTP/2 is enabled, otherwise set 0 if not enabled'
        },
        Delivery_and_Render_Total_Score: MetricesCalculation_Data.metric.deliveryAndRender.deliveryAndRenderTotal,
      },
      Crawlability_and_Hygiene: {
        Sitemap:{
          Score: MetricesCalculation_Data.metric.crawlabilityAndHygiene.sitemapScore,
          Parameter:'Set 1 if /sitemap.xml exists, otherwise set 0'
        },
        Robots:{
          Score: MetricesCalculation_Data.metric.crawlabilityAndHygiene.robotsScore,
          Parameter:'Set 1 if robots.txt exists, otherwise set 0'
        },
        Structured_Data:{
          Score: MetricesCalculation_Data.metric.crawlabilityAndHygiene.structuredDataScore,
          Parameter:'Set 1 if JSON-LD structured data is present, otherwise set 0'
        },
        Broken_Links:{
          Score: MetricesCalculation_Data.metric.crawlabilityAndHygiene.brokenScore,
          Value: MetricesCalculation_Data.metric.crawlabilityAndHygiene.brokenPercent,
          Parameter:'Set 1 if 0% broken links, otherwise set 0'
        },
        Redirect_Chains:{
          Score: MetricesCalculation_Data.metric.crawlabilityAndHygiene.redirectScore,
          Value: MetricesCalculation_Data.metric.crawlabilityAndHygiene.hops,
          Parameter:'Set 1 if ≤ 1 hop, otherwise set 0'
        },
        Crawlability_and_Hygiene_Total_Score: MetricesCalculation_Data.metric.crawlabilityAndHygiene.crawlabilityAndHygieneTotal,
      },
      Percentage: MetricesCalculation_Data.metric.actualPercentage,
      Warning: MetricesCalculation_Data.metric.warning,
      Passed: MetricesCalculation_Data.metric.passed,
      Total: MetricesCalculation_Data.metric.Total,
      Improvements: MetricesCalculation_Data.metric.improvements,
    },
        }
        break;
    ...
    On_Page_SEO: {
      Essentials: {
        Title: {
          Title: MetricesCalculation_Data.metric.essentials.title,
          Title_Exist : MetricesCalculation_Data.metric.essentials.titleExistanceScore,
          Title_Length: MetricesCalculation_Data.metric.essentials.titleLength,
          Score: MetricesCalculation_Data.metric.essentials.titleScore,
          Parameter:'1 if title exists and 30–60 characters, else 0'
        },
        Meta_Description: {
          MetaDescription: MetricesCalculation_Data.metric.essentials.metaDesc,
          MetaDescription_Exist: MetricesCalculation_Data.metric.essentials.metaDescExistanceScore,
          MetaDescription_Length: MetricesCalculation_Data.metric.essentials.metaDescLength,
          Score: MetricesCalculation_Data.metric.essentials.metaDescScore,
          Parameter:'1 if meta description exists and ≤ 165 characters, else 0'
        },
        URL_Structure: {
          Score: MetricesCalculation_Data.metric.essentials.URLStructureScore,
          Parameter:'1 if URL ≤ 5 segments, lowercase, hyphen-separated, else 0'
        },
        Canonical: {
          Canonical: MetricesCalculation_Data.metric.essentials.canonical,
          Canonical_Exist: MetricesCalculation_Data.metric.essentials.canonicalExistanceScore,
          Score: MetricesCalculation_Data.metric.essentials.canonicalScore,
          Parameter:'1 if canonical tag exists and matches page URL, else 0'
        },
        Essentials_Total_Score: MetricesCalculation_Data.metric.essentials.essentialsTotal,
      },
      Media_and_Semantics: {
        H1: {
          H1_Count: MetricesCalculation_Data.metric.mediaAndSemantics.h1Count,
          H1_Count_Score: MetricesCalculation_Data.metric.mediaAndSemantics.h1CountScore,
          Score: MetricesCalculation_Data.metric.mediaAndSemantics.h1Score,
          Parameter:'1 if exactly one H1, 2 if >1, 0 if none'
        },
        Image:{
          Image_Exist: MetricesCalculation_Data.metric.mediaAndSemantics.imagePresenceScore,
          Image_Alt_Exist: MetricesCalculation_Data.metric.mediaAndSemantics.altPresence,
          Image_Alt_Meaningfull_Exist: MetricesCalculation_Data.metric.mediaAndSemantics.altMeaningfullPercentage,
          Image_Compression_Exist: MetricesCalculation_Data.metric.mediaAndSemantics.imageCompressionScore,
          Parameter:'Alt text ≥ 75% meaningful, images ≤ 200KB'
        },
        Video:{
          Video_Exist: MetricesCalculation_Data.metric.mediaAndSemantics.videoExistanceScore,
          Video_Embedding_Exist: MetricesCalculation_Data.metric.mediaAndSemantics.embedding,
          Video_LazyLoading_Exist: MetricesCalculation_Data.metric.mediaAndSemantics.lazyLoading,
          Video_Structured_Metadata_Exist: MetricesCalculation_Data.metric.mediaAndSemantics.structuredMetadata,
          Parameter:'Proper embedding, lazy-loading, JSON-LD metadata'
        },
        Heading_Hierarchy:{
          H1_Count: MetricesCalculation_Data.metric.mediaAndSemantics.h1Count,
          H2_Count: MetricesCalculation_Data.metric.mediaAndSemantics.h2Count,
          H3_Count: MetricesCalculation_Data.metric.mediaAndSemantics.h3Count,
          H4_Count: MetricesCalculation_Data.metric.mediaAndSemantics.h4Count,
          H5_Count: MetricesCalculation_Data.metric.mediaAndSemantics.h5Count,
          H6_Count: MetricesCalculation_Data.metric.mediaAndSemantics.h6Count,
          Heading: MetricesCalculation_Data.metric.mediaAndSemantics.headings,
          Score:MetricesCalculation_Data.metric.mediaAndSemantics.hierarchy,
          Parameter:'1 if headings follow proper H1→H2→H3 order, else 0',
        },
        ALT_Text_Relevance: {
          Score: MetricesCalculation_Data.metric.mediaAndSemantics.alttextScore,
          Parameter: "1 if alt text contains keywords or is descriptive, else 0"
        },
        Internal_Links: {
          Total: MetricesCalculation_Data.metric.mediaAndSemantics.totalInternalLinks,
          Descriptive_Score: MetricesCalculation_Data.metric.mediaAndSemantics.internalLinksDescriptiveScore,
          Parameter: "1 if ≥ 75% internal links are descriptive, else 0"
        },
        Semantic_Tags: {
          Article_Score: MetricesCalculation_Data.metric.mediaAndSemantics.articleScore,
          Section_Score: MetricesCalculation_Data.metric.mediaAndSemantics.sectionScore,
          Header_Score: MetricesCalculation_Data.metric.mediaAndSemantics.headerScore,
          Footer_Score: MetricesCalculation_Data.metric.mediaAndSemantics.footerScore,
          Parameter: "1 if tag exists, else 0"
        },
        Media_and_Semantics_Total_Score: MetricesCalculation_Data.metric.mediaAndSemantics.mediaAndSemanticsTotal
      },
      Structure_and_Uniqueness: {
        Duplicate_Content:{
          Score: MetricesCalculation_Data.metric.structureAndUniqueness.dupScore,
          Parameter:'1 if duplication ≤ 75%, else 0'
        },
         URL_Slugs:{
          Slug:MetricesCalculation_Data.metric.structureAndUniqueness.slug,
          Slug_Check_Score:MetricesCalculation_Data.metric.structureAndUniqueness.slugCheckScore,
          Score:MetricesCalculation_Data.metric.structureAndUniqueness.slugScore,
          Parameter:'1 if slug exists, ≤25 characters, lowercase hyphenated, else 0'
        },
        HTTPS: {
          Score: MetricesCalculation_Data.metric.structureAndUniqueness.checkHTTPSScore,
          Parameter: "1 if HTTPS implemented, else 0"
        },
        Pagination_Tags:{
          Score: MetricesCalculation_Data.metric.structureAndUniqueness.paginationScore,
          Parameter:'1 if pagination links or rel=next/prev exist, else 0'
        },
        Structure_and_Uniqueness_Total_Score: MetricesCalculation_Data.metric.structureAndUniqueness.structureAndUniquenessTotal,
      },
      Percentage: MetricesCalculation_Data.metric.actualPercentage,
      Warning: MetricesCalculation_Data.metric.warning,
      Passed: MetricesCalculation_Data.metric.passed,
    ...
    Security_or_Compliance: {
      HTTPS: {
        Score: MetricesCalculation_Data.metric.checkHTTPSScore,
        Parameter: '1 if HTTPS is implemented, else 0'
      },
      SSL: {
        Score: MetricesCalculation_Data.metric.checkSSLScore,
        Parameter: '1 if SSL/TLS certificate is valid, else 0'
      },
      SSL_Expiry: {
        Score: MetricesCalculation_Data.metric.checkSSLCertificateExpiryScore,
        Parameter: '1 if SSL certificate is not expired, else 0'
      },
      HSTS: {
        Score: MetricesCalculation_Data.metric.checkHSTSScore,
        Parameter: '1 if HSTS header is present, else 0'
      },
      TLS_Version: {
        Score: MetricesCalculation_Data.metric.checkTLSVersionScore,
        Parameter: '1 if secure TLS version is used, else 0'
      },
      X_Frame_Options: {
        Score: MetricesCalculation_Data.metric.checkXFrameOptionsScore,
        Parameter: '1 if X-Frame-Options header is set, else 0'
      },
      CSP: {
        Score: MetricesCalculation_Data.metric.checkCSPScore,
        Parameter: '1 if Content Security Policy (CSP) is set, else 0'
      },
      X_Content_Type_Options: {
        Score: MetricesCalculation_Data.metric.checkXContentTypeOptionsScore,
        Parameter: '1 if X-Content-Type-Options header is set, else 0'
      },
      Cookies_Secure: {
        Score: MetricesCalculation_Data.metric.checkCookiesSecureScore,
        Parameter: '1 if cookies are set with Secure flag, else 0'
      },
      Cookies_HttpOnly: {
        Score: MetricesCalculation_Data.metric.checkCookiesHttpOnlyScore,
        Parameter: '1 if cookies are HttpOnly, else 0'
      },
      Google_Safe_Browsing: {
        Score: MetricesCalculation_Data.metric.safeBrowsingScore,
        Parameter: '1 if site is safe according to Google Safe Browsing, else 0'
      },
      Blacklist: {
        Score: MetricesCalculation_Data.metric.blacklistScore,
        Parameter: '1 if site is not blacklisted, else 0'
      },
      Malware_Scan: {
        Score: MetricesCalculation_Data.metric.malwareScanScore,
        Parameter: '1 if no malware detected, else 0'
      },
      SQLi_Exposure: {
        Score: MetricesCalculation_Data.metric.sqliExposureScore,
        Parameter: '1 if site is not vulnerable to SQL injection, else 0'
      },
      XSS: {
        Score: MetricesCalculation_Data.metric.xssVulnerabilityScore,
        Parameter: '1 if site is not vulnerable to XSS, else 0'
      },
      Cookie_Consent: {
        Score: MetricesCalculation_Data.metric.cookieConsentScore,
        Parameter: '1 if cookie consent banner is implemented, else 0'
      },
      Privacy_Policy: {
        Score: MetricesCalculation_Data.metric.privacyPolicyScore,
        Parameter: '1 if privacy policy exists, else 0'
      },
      Forms_Use_HTTPS: {
        Score: MetricesCalculation_Data.metric.formsUseHTTPSScore,
        Parameter: '1 if forms submit over HTTPS, else 0'
      },
      GDPR_CCPA: {
        Score: MetricesCalculation_Data.metric.checkGDPRCCPAScore,
        Parameter: '1 if GDPR/CCPA compliance implemented, else 0'
      },
      Data_Collection: {
        Score: MetricesCalculation_Data.metric.checkDataCollectionScore,
        Parameter: '1 if data collection practices are compliant, else 0'
      },
      Weak_Default_Credentials: {
        Score: MetricesCalculation_Data.metric.weakDefaultCredsScore,
        Parameter: '1 if no weak default credentials exist, else 0'
      },
      MFA_Enabled: {
        Score: MetricesCalculation_Data.metric.mfaEnabledScore,
        Parameter: '1 if multi-factor authentication is enabled, else 0'
      },
      Admin_Panel_Public: {
        Score: MetricesCalculation_Data.metric.checkAdminPanelPublicScore,
        Parameter: '1 if admin panel is not publicly accessible, else 0'
      },
      Viewport_Meta_Tag: {
        Score: MetricesCalculation_Data.metric.checkViewportMetaTagScore,
        Parameter: '1 if <meta name="viewport" content="width=device-width, initial-scale=1.0"> is present, else 0'
      },
      HTML_Doctype: {
        Score: MetricesCalculation_Data.metric.checkHtmlDoctypeScore,
        Parameter: '1 if <!DOCTYPE html> is declared at document start, else 0'
      },
      Character_Encoding: {
        Score: MetricesCalculation_Data.metric.checkCharsetDefinedScore,
        Parameter: '1 if charset is defined in <meta> or HTTP headers, else 0'
      },
      Browser_Console_Errors: {
        Score: MetricesCalculation_Data.metric.checkBrowserErrorsScore,
        Parameter: '1 if no console or JS errors are detected, else 0'
      },
      Geolocation_Request: {
        Score: MetricesCalculation_Data.metric.checkGeolocationRequestScore,
        Parameter: '1 if geolocation is not requested automatically, else 0'
      },
      Input_Paste_Allowed: {
        Score: MetricesCalculation_Data.metric.checkInputPasteAllowedScore,
        Parameter: '1 if paste is allowed in input fields, else 0'
      },
      Notification_Request: {
        Score: MetricesCalculation_Data.metric.checkNotificationRequestScore,
        Parameter: '1 if no unsolicited notification request is made, else 0'
      },
      Third_Party_Cookies: {
        Score: MetricesCalculation_Data.metric.checkThirdPartyCookiesScore,
        Parameter: '1 if no third-party cookies are detected, else 0'
      },
      Deprecated_APIs: {
        Score: MetricesCalculation_Data.metric.checkDeprecatedAPIsScore,
    ...
    Conversion_and_Lead_Flow: {
      CTA_and_Forms: {
        CTA_Visibility: {
          Score: MetricesCalculation_Data.metric.checkCTAsScore,
          Parameter: "1 if at least one prominent CTA is present, else 0"
        },
        CTA_Clarity: {
          Score: MetricesCalculation_Data.metric.checkCTAClarityScore,
          Parameter: "1 if CTA buttons and links have clear, actionable text, else 0"
        },
        CTA_Contrast: {
          Score: MetricesCalculation_Data.metric.checkCTAContrastScore,
          Parameter: "1 if CTA text has sufficient contrast (≥4.5:1), else 0"
        },
        CTA_Crowding: {
          Score: MetricesCalculation_Data.metric.checkCTACrowdingScore,
          Parameter: "1 if number of CTAs is limited to prevent confusion, else 0"
        },
        CTA_Flow_Alignment: {
          Score: MetricesCalculation_Data.metric.checkCTAFlowAlignmentScore,
          Parameter: "1 if CTAs are placed logically along user flow, else 0"
        },
        Form_Presence: {
          Score: MetricesCalculation_Data.metric.checkFormPresenceScore,
          Parameter: "1 if at least one form is present, else 0"
        },
        Form_Length: {
          Score: MetricesCalculation_Data.metric.checkFormLengthOptimalScore,
          Parameter: "1 if forms are concise, else 0"
        },
        Required_vs_Optional_Fields: {
          Score: MetricesCalculation_Data.metric.checkRequiredVsOptionalFieldsScore,
          Parameter: "1 if required vs optional fields are clearly marked, else 0"
        },
        Inline_Validation: {
          Score: MetricesCalculation_Data.metric.checkInlineValidationScore,
          Parameter: "1 if real-time feedback is provided for user input, else 0"
        },
        Submit_Button_Clarity: {
          Score: MetricesCalculation_Data.metric.checkSubmitButtonClarityScore,
          Parameter: "1 if submit button text is clear and actionable, else 0"
        },
        AutoFocus_Field: {
          Score: MetricesCalculation_Data.metric.checkAutoFocusFieldScore,
          Parameter: "1 if first input field is autofocused, else 0"
        },
        MultiStep_Form_Progress: {
          Score: MetricesCalculation_Data.metric.checkMultiStepFormProgressScore,
          Parameter: "1 if progress indicators exist in multi-step forms, else 0"
        }
      },
      Trust_and_SocialProof: {
        Testimonials: {
          Score: MetricesCalculation_Data.metric.checkTestimonialsScore,
          Parameter: "1 if testimonials are visible, else 0"
        },
        Reviews: {
          Score: MetricesCalculation_Data.metric.checkReviewsVisibleScore,
          Parameter: "1 if reviews/ratings are visible, else 0"
        },
        Trust_Badges: {
          Score: MetricesCalculation_Data.metric.checkTrustBadgesScore,
          Parameter: "1 if trust/security badges are visible, else 0"
        },
        Client_Logos: {
          Score: MetricesCalculation_Data.metric.checkClientLogosScore,
          Parameter: "1 if client logos are visible, else 0"
        },
        Case_Studies_Accessibility: {
          Score: MetricesCalculation_Data.metric.checkCaseStudiesAccessibilityScore,
          Parameter: "1 if case studies are accessible, else 0"
        }
      },
      Lead_Funnel: {
        Exit_Intent_Triggers: {
          Score: MetricesCalculation_Data.metric.checkExitIntentTriggersScore,
          Parameter: "1 if exit-intent triggers exist, else 0"
        },
        Lead_Magnets: {
          Score: MetricesCalculation_Data.metric.checkLeadMagnetsScore,
          Parameter: "1 if lead magnets are offered, else 0"
        },
        Contact_Info_Visibility: {
          Score: MetricesCalculation_Data.metric.checkContactInfoVisibilityScore,
          Parameter: "1 if contact info is visible, else 0"
        },
        Chatbot_Presence: {
          Score: MetricesCalculation_Data.metric.checkChatbotPresenceScore,
          Parameter: "1 if chatbot is present, else 0"
        }
      },
      UX_and_Interaction: {
        Interactive_Elements: {
          Score: MetricesCalculation_Data.metric.checkInteractiveElementsScore,
          Parameter: "1 if interactive elements are present, else 0"
        },
        Personalization: {
          Score: MetricesCalculation_Data.metric.checkPersonalizationScore,
          Parameter: "1 if personalized content exists, else 0"
        },
        Progress_Indicators: {
          Score: MetricesCalculation_Data.metric.checkProgressIndicatorsScore,
          Parameter: "1 if progress indicators are visible, else 0"
        },
        Friendly_Error_Handling: {
          Score: MetricesCalculation_Data.metric.checkFriendlyErrorHandlingScore,
          Parameter: "1 if error messages are clear and helpful, else 0"
        },
        Microcopy_Clarity: {
          Score: MetricesCalculation_Data.metric.checkMicrocopyClarityScore,
          Parameter: "1 if labels/placeholders are clear, else 0"
        },
        Incentives_Displayed: {
          Score: MetricesCalculation_Data.metric.checkIncentivesDisplayedScore,
          Parameter: "1 if offers or incentives are visible, else 0"
        },
        Scarcity_Urgency: {
          Score: MetricesCalculation_Data.metric.checkScarcityUrgencyScore,
          Parameter: "1 if scarcity or urgency cues are present, else 0"
        },
        Smooth_Scrolling: {
          Score: MetricesCalculation_Data.metric.checkSmoothScrollingScore,
          Parameter: "1 if smooth scrolling is implemented, else 0"
        },
        Mobile_CTA_Adaptation: {
          Score: MetricesCalculation_Data.metric.checkMobileCTAAdaptationScore,
          Parameter: "1 if CTAs are mobile-friendly, else 0"
        },
        MultiChannel_FollowUp: {
          Score: MetricesCalculation_Data.metric.checkMultiChannelFollowUpScore,
