...
const DeveloperViewNotice = ({ darkMode, sectionName, onSwitch }) => (
    <div className={`w-full min-h-[65vh] flex items-start justify-center px-4 py-16 ${darkMode ? "bg-gray-900" : "bg-gray-50"}`}>
        <div
            className={`w-full max-w-2xl flex flex-col items-center text-center rounded-2xl border px-8 py-16 shadow-sm ${darkMode ? "bg-gray-800 border-gray-700 text-gray-300" : "bg-white border-gray-200 text-gray-600"
                }`}
        >
